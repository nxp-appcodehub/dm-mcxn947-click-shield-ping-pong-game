...
typedef struct
{
	...
	lv_obj_t *screen;
	bool screen_del;
	lv_obj_t *screen_barL_img;
	lv_obj_t *screen_barR_img;
	lv_obj_t *screen_ball_img;
	lv_obj_t *screen_game_over_label;
	lv_obj_t *screen_winer_label;
}lv_ui;
...
LV_IMG_DECLARE(_white_background_alpha_4x30);
LV_IMG_DECLARE(_white_background_alpha_4x30);
LV_IMG_DECLARE(_white_background_alpha_4x4);
